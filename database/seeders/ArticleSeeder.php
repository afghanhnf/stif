    ...
    public function run(): void
    {
        $articles = [
            [
                ...
                'read_time_minutes' => 6,
                'featured_image' => 'article-buildings.png',
            ],
            [
                ...
                'read_time_minutes' => 4,
                'featured_image' => 'article-spiral.png',
            ],
            [
                ...
                'read_time_minutes' => 8,
                'featured_image' => 'article-office.png',
            ],
            [
            ...
            [
                ...
                'featured_image' => 'case-agriculture.png',
            ],
            [
                ...
                'read_time_minutes' => 5,
                'featured_image' => 'case-manufacturing.png',
            ],
        ];

        foreach ($articles as $article) {
            $genericContentEn = '<p class="intro">This is a full article content for ' . $article['title_en'] . '. It demonstrates how rich text will be structured.</p><p>We have meticulously designed this structure to provide the utmost clarity and compliance. This text can be edited via the Filament Admin panel using the Rich Editor component.</p><h2>Key Takeaways</h2><ul><li>Ensuring Sharia compliance</li><li>Enhancing sustainable growth</li><li>Delivering impactful results</li></ul><blockquote>"Integrity is the foundation of our structuring approach."</blockquote>';
            $genericContentId = '<p class="intro">Ini adalah konten artikel lengkap untuk ' . $article['title_id'] . '. Ini mendemonstrasikan bagaimana teks kaya (rich text) akan disusun.</p><p>Kami telah merancang struktur ini secara cermat untuk memberikan kejelasan dan kepatuhan maksimal. Teks ini dapat diedit melalui panel Admin Filament menggunakan komponen Rich Editor.</p><h2>Poin Utama</h2><ul><li>Memastikan kepatuhan Syariah</li><li>Meningkatkan pertumbuhan berkelanjutan</li><li>Memberikan hasil yang berdampak</li></ul><blockquote>"Integritas adalah fondasi dari pendekatan penataan kami."</blockquote>';
